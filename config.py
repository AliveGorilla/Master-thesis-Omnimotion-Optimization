...
def config_parser():
    ...
    parser.add_argument('--freeze_step', type=int, default=40000,
                        help='after what step to freeze the feature network')
    ...
    # network training
    parser.add_argument('--use_error_map', action='store_false', help='use error map')
